...
import net.goldorion.pluginmaker.ui.modgui.BlocklyBlockGUI;
...
public class PluginElementTypes {
    ...
    public static ModElementType<?> BLOCKLY_BLOCK;
    ...
    public static void load() {
        ...
        BLOCKLY_BLOCK = register(
                new ModElementType<>("blockly_block", 'b', BaseType.OTHER, RecipeType.NONE, BlocklyBlockGUI::new, BlocklyBlock.class));
    }
}